...
const filters = [
  {
    ...
    options: [
      ...
      { value: 'DiorDolce & Gabbana', label: 'DiorDolce & Gabbana', checked: false },
      { value: 'Gucci', label: 'Gucci', checked: false },
      { value: 'Annibale Colombo', label: 'Annibale Colombo', checked: false },
      { value: 'Furniture Co.r', label: 'Furniture Co.', checked: false },
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {Array.isArray(products) && products?.map((product) => (
            <Link to='/product-detail'>
              <div key={product.id} className="shadow-xl rounded-xl p-2 group relative">
                ...
                <div className="mt-4 flex justify-between">
                  ...
                  <div className='text-center'>
                    <p className="mx-1 text-sm font-medium text-gray-900">${Math.round(product.price * (1 - product.discountPercentage / 100))}</p>
                    <p className="line-through mx-1 text-sm font-medium text-gray-400">${product.price}</p>
                  </div>
                </div>
              </div>
            </Link>
