        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className='py-8 grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5'>
                <div className='lg:col-span-3'>
                    <form>
                        <div className="space-y-12 my-10 bg-white p-5 md:p-10">
                ...
                <div className='lg:col-span-2'>
                    <div className="bg-white mt-10 mx-auto max-w-7xl p-5">
                        <h2 className="font-bold text-4xl my-4 py-4 px-4 sm:px-6 lg:px-8">Cart</h2>
                                        ...
                                        <li key={product.id} className="flex py-6">
                                            ...
                                            <div className="ml-4 flex flex-1 flex-col">
                                                ...
                                                <div className="flex flex-1 items-end justify-between text-sm">
                                                    <p className="text-gray-500 md:flex items-center justify-center gap-5">
                                                        Qty
                                                        <div>
                                                            <select className='rounded-xl my-2'>
